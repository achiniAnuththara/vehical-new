...
<body>
    ...
    <div class="container">
        <form action="InsertServiceServlet" method="post" id="form">
            <h1>ADD SERVICES</h1>
            ...
            <div class="input-group">
                ...
                <input type="text" name="service_type" id="sname" >
                <div class="error"></div>
            </div>

            <div class="input-group">
                <label>SERVICE DESCRIPTION:</label>
                <textarea name="service_description" rows="4" ></textarea>
            </div>

            <div class="input-group">
                <label>SERVICE DATE:</label>
                <input type="date" name="service_date" id="sdate" >
                <div class="error"></div>
            </div>

            <div class="input-group">
                <label>SERVICE COST:</label>
                <input type="number" name="service_cost" id="price" step="0.01" >
                <div class="error"></div>
            </div>

            <div class="input-group">
                <label>SERVICE CENTER:</label>
                <input type="text" name="service_center" >
                <div class="error"></div>
            </div>

            <div class="button-group">
                <input type="submit" value="Submit" class="but10">
            </div>
        </form>
