...
<form action="InsertFuelServlet" method="post">
    ...
    <input type="text" id="fuelType" name="fuel_type" placeholder="Enter Fuel Type (e.g., Petrol, Diesel)" required>
    ...
    <input type="number" id="price" name="price_per_liter" step="0.01" min="0" required>

    <label for="supplier">Supplier Name:</label>
    <input type="text" id="supplier" name="supplier_name" placeholder="Enter Supplier Name" required>
