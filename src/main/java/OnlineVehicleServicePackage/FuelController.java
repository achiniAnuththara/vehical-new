...
public class FuelController {
	...
	//insertData function
    public static boolean insertData(String fuel_type, double quantity_liters, double price_per_liter, String supplier_name, LocalDate added_date) {
        ...
        try {
            ...
            String sql = "INSERT INTO fuel (fuel_type, quantity_liters, price_per_liter, supplier_name, added_date) "
                       + "VALUES ('" + fuel_type + "', " + quantity_liters + ", " + price_per_liter + ", '" + supplier_name + "', '" + added_date_str + "')";
    ...
    public static List<FuelModel> getById(String id){
    	...
    	try {
            ...
            while(rs.next()) {
            	...
            	FuelModel fl = new FuelModel(fuel_id, fuel_type, quantity_liters, price_per_liter, supplier_name, added_date);
            	fuel.add(fl);
    ...
    //Update data
    public static boolean updatedata(int fuel_id, String fuel_type, double quantity_liters, double price_per_liter, String supplier_name, LocalDate added_date) {
        boolean isSuccess = false;
        ...
        try {
            ...
            String sql = "UPDATE fuel SET fuel_type = '" + fuel_type + 
